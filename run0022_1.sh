python exp0022.py fold=0 batch_size=64 epoch=20 height=512 width=512 model_name=gluon_seresnext50_32x4d drop_rate=0.2 drop_path_rate=0.0 \
data_dir=/kqi/parent/22020972 output_dir=/kqi/output/fold0_0

python exp0022.py fold=1 batch_size=64 epoch=20 height=512 width=512 model_name=gluon_seresnext50_32x4d drop_rate=0.2 drop_path_rate=0.0 \
data_dir=/kqi/parent/22020972 output_dir=/kqi/output/fold1_0

python exp0022.py fold=2 batch_size=64 epoch=20 height=512 width=512 model_name=gluon_seresnext50_32x4d drop_rate=0.2 drop_path_rate=0.0 \
data_dir=/kqi/parent/22020972 output_dir=/kqi/output/fold2_0

python exp0022.py fold=3 batch_size=64 epoch=20 height=512 width=512 model_name=gluon_seresnext50_32x4d drop_rate=0.2 drop_path_rate=0.0 \
data_dir=/kqi/parent/22020972 output_dir=/kqi/output/fold3_0

python exp0022.py fold=4 batch_size=64 epoch=20 height=512 width=512 model_name=gluon_seresnext50_32x4d drop_rate=0.2 drop_path_rate=0.0 \
