...
python baseline_1_pseudo_chi2.py fold=0 batch_size=36 epoch=10 height=512 width=512 model_name=tf_efficientnet_b5_ns drop_rate=0.4 drop_path_rate=0.2 \
...
python baseline_1_pseudo_chi2.py fold=1 batch_size=36 epoch=10 height=512 width=512 model_name=tf_efficientnet_b5_ns drop_rate=0.4 drop_path_rate=0.2 \
...
python baseline_1_pseudo_chi2.py fold=2 batch_size=36 epoch=10 height=512 width=512 model_name=tf_efficientnet_b5_ns drop_rate=0.4 drop_path_rate=0.2 \
...
python baseline_1_pseudo_chi2.py fold=3 batch_size=36 epoch=10 height=512 width=512 model_name=tf_efficientnet_b5_ns drop_rate=0.4 drop_path_rate=0.2 \
...
python baseline_1_pseudo_chi2.py fold=4 batch_size=36 epoch=10 height=512 width=512 model_name=tf_efficientnet_b5_ns drop_rate=0.4 drop_path_rate=0.2 \
