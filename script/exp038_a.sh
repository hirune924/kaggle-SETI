...
python baseline_1_ns.py fold=0 batch_size=64 epoch=20 height=512 width=512 model_name=tf_efficientnet_b6_ns drop_rate=0.5 drop_path_rate=0.2 \
...
python baseline_1_ns.py fold=1 batch_size=64 epoch=20 height=512 width=512 model_name=tf_efficientnet_b6_ns drop_rate=0.5 drop_path_rate=0.2 \
...
python baseline_1_ns.py fold=2 batch_size=64 epoch=20 height=512 width=512 model_name=tf_efficientnet_b6_ns drop_rate=0.5 drop_path_rate=0.2 \
...
python baseline_1_ns.py fold=3 batch_size=64 epoch=20 height=512 width=512 model_name=tf_efficientnet_b6_ns drop_rate=0.5 drop_path_rate=0.2 \
...
python baseline_1_ns.py fold=4 batch_size=64 epoch=20 height=512 width=512 model_name=tf_efficientnet_b6_ns drop_rate=0.5 drop_path_rate=0.2 \
