...
class LitSystem(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        aucroc_loss = self.rocaucloss(y_hat, y)

        return loss + aucroc_loss * 10
    ...
    def validation_epoch_end(self, outputs):
        ...
        avg_val_aucroc_loss = torch.stack([x["aucroc_loss"] for x in outputs]).mean()
        ...
        self.log('avg_val_aucroc_loss', avg_val_aucroc_loss)
