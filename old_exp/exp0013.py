...
class LitSystem(pl.LightningModule):
    def __init__(self, conf):
        ...
        self.criteria = AUCMLoss(imratio=0.1)
    ...
    def configure_optimizers(self):
        ...
        optimizer = PESG(self.model, 
                 a=self.criteria.a, 
                 b=self.criteria.b, 
                 alpha=self.criteria.alpha, 
                 imratio=0.1, 
                 lr=self.hparams.lr, 
                 gamma=500, 
                 margin=1e-4, 
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.optimizers(use_pl_optimizer=True).zero_grad()
        self.manual_backward(loss, retain_graph=True)
        self.optimizers(use_pl_optimizer=True).step()
